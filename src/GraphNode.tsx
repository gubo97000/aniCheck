import { Avatar, Box, Checkbox, CircularProgress, FormControlLabel, Grid, Icon, IconButton, List, ListItem, ListItemAvatar, ListItemIcon, ListItemSecondaryAction, ListItemText, Paper, Radio, Typography } from '@material-ui/core'
    ...
    return (
        <Paper sx={{
            ...
            <Grid container sx={{ height: "100%" }}>
                ...
                <Grid item xs={6} sx={{
                    borderTop: "solid 1px", borderColor: "grey.500",
            ...
            <Box sx={{
                ...
                margin: "auto", width: "100%", transform: "rotate(45deg)",
                position: "absolute",
                right: "-3px",
                top: "9px",
            }}>
